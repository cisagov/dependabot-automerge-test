...
issue](https://github.com/cisagov/dependabot-automerge-test/issues) in this
...
request](https://github.com/cisagov/dependabot-automerge-test/pulls), you will
...
```console
cd dependabot-automerge-test
pyenv virtualenv <python_version_to_use> dependabot-automerge-test
pyenv local dependabot-automerge-test
